...
// Let's create helper code snippets for Chinese and Hebrew Drag and Drop Configurator

const dndChineseWordsCode = `
interface DndWordItem {
  id: string;
  char: string;
  pinyin: string;
  vuk: string;
...
const DND_CHINESE_WORDS: DndWordItem[] = [
  // Pronouns / Subjects
...
console.log('Snippet length:', dndChineseWordsCode.length);
